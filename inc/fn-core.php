...
function am_add_javascript( ) {
    ...
    if( !is_admin() ) {
        ...
        $am_files = array(
                        '/assets/js/barba.umd.js',
                        '/assets/js/gsap.min.js', 
                        '/assets/js/smooth-scrollbar.min.js', 
                        '/assets/js/ScrollTrigger.min.js', 
                        '/assets/js/ScrollToPlugin.min.js',
                        '/assets/js/Draggable.min.js', 
                        '/assets/js/slick.js'); // example: array('script1', 'script2');
...
function am_add_css( ) {
    ...
    // internal CSS
    $am_files = array('assets/css/slick.css', '/assets/css/style.css', 'style.css'); // example: array('style1', 'style2');
    foreach($am_files as $am_file){
